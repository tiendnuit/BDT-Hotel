...
sudo sh /home/cloudera/git/BDT-Hotel1/script/pushData | /home/cloudera/Downloads/kafka_2.12-2.4.1/bin/kafka-console-producer.sh --broker-list localhost:9092 --topic HotelBookingSummary1